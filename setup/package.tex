...
\lstset{%
	...
	alsolanguage=python,				% 可以添加多个语言选项
...
\setsansfont{NotoSerifSC-Regular.otf}[Path = ./fonts/]
\setCJKmonofont{NotoSerifSC-Regular.otf}[Path = ./fonts/]
% \setCJKmainfont{SimSun.ttf}
\setCJKmainfont{NotoSerifSC-Regular.otf}[Path = ./fonts/]
%\setCJKsansfont{SimHei.ttf}
\setCJKsansfont{NotoSerifSC-Regular.otf}[Path = ./fonts/]

\setCJKfamilyfont{hei}{NotoSerifSC-Bold.otf}[Path = ./fonts/]
\newcommand{\hei}{\CJKfamily{hei}}

%\setCJKfamilyfont{hanyi}{HYShangWeiShouShuW-1.ttf}[Path = ./fonts/]
%\newcommand{\hanyi}{\CJKfamily{hanyi}}

\setCJKfamilyfont{yahei}{NotoSanCN.otf}[Path = ./fonts/]
